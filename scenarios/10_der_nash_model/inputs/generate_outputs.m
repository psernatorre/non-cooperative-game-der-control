...
variables = ["PV1_P", "BESS2_P" , "BESS3_P", "PV4_P", "PV5_P", "BESS6_P", "PV7_P", "BESS8_P", "BESS9_P", "BESS10_P", "Load_P", "Grid_P", "Grid_Preq"];
...
ders = ["PV1", "BESS2", "BESS3", "PV4", "PV5", "BESS6", "PV7", "BESS8", "BESS9", "BESS10"];
