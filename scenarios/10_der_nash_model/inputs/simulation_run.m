...
%% PV7 Parameters
% -------------------------------------------------------------------------
PV7.Pref        = PV7.Pini;     % [W] real power output (initial condition)
PV7.Qref        = 0e6;     % [VA] reactive power output reference (negative is capacitive)
PV7.Vbase       = 690;      % [V] device voltage base
PV7.VbaseDC     = 600*30;   % [v] for the capacitor
%
PV7.rating      = 60e6;     % [VA] nameplate rating
%
PV7.irr.rating  = 1000;     % [W/m^2] rated irradiance input for rated output
PV7.irr.ref     = 1000;     % [W/m^2] used as constant irradiance input

%% BESS8 Parameters
% -------------------------------------------------------------------------
BESS8.Pref       = BESS8.Pini;   % [W] real power output (initial condition)
BESS8.rating     = 10e6;        % [VA] Inverter rating
BESS8.Qref       = -1e6;        % [VA] Reference Reactive Power
BESS8.Vbase      = 480;         % [V] Inverter voltage
BESS8.VbaseDC    = 1000;        % DC voltage at the input of the inverter

BESS8.maxContPower   = BESS8.rating ;   % [VA] Maximum Continuos Power
BESS8.capacity       = 1221;            % [kWh] BESS Capacity - Note: This value needs to be verified
BESS8.efficiency     = 85;              % [%] BESS Efficiency
BESS8.initSOC        = 50;              % [%] Initial SoC
BESS8.minSOC         = 10;              % [%] Minimum SoC limit
BESS8.maxSOC         = 90;              % [%] Maximum SoC limit

%% BESS9 Parameters
% -------------------------------------------------------------------------
BESS9.Pref       = BESS9.Pini;   % [W] real power output (initial condition)
BESS9.rating     = 10e6;        % [VA] Inverter rating
BESS9.Qref       = -1e6;        % [VA] Reference Reactive Power
BESS9.Vbase      = 480;         % [V] Inverter voltage
BESS9.VbaseDC    = 1000;        % DC voltage at the input of the inverter

BESS9.maxContPower   = BESS9.rating ;   % [VA] Maximum Continuos Power
BESS9.capacity       = 1221;            % [kWh] BESS Capacity - Note: This value needs to be verified
BESS9.efficiency     = 85;              % [%] BESS Efficiency
BESS9.initSOC        = 50;              % [%] Initial SoC
BESS9.minSOC         = 10;              % [%] Minimum SoC limit
BESS9.maxSOC         = 90;              % [%] Maximum SoC limit

%% BESS10 Parameters
% -------------------------------------------------------------------------
BESS10.Pref       = BESS10.Pini;   % [W] real power output (initial condition)
BESS10.rating     = 10e6;        % [VA] Inverter rating
BESS10.Qref       = -1e6;        % [VA] Reference Reactive Power
BESS10.Vbase      = 480;         % [V] Inverter voltage
BESS10.VbaseDC    = 1000;        % DC voltage at the input of the inverter

BESS10.maxContPower   = BESS10.rating ;   % [VA] Maximum Continuos Power
BESS10.capacity       = 1221;            % [kWh] BESS Capacity - Note: This value needs to be verified
BESS10.efficiency     = 85;              % [%] BESS Efficiency
BESS10.initSOC        = 50;              % [%] Initial SoC
BESS10.minSOC         = 10;              % [%] Minimum SoC limit
BESS10.maxSOC         = 90;              % [%] Maximum SoC limit
