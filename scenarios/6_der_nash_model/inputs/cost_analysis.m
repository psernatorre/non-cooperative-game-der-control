...
results = zeros(n_intervals+1,2+6);
...
for k = 1:1:n_intervals
    ...
    x_g = [x_pv1_g; x_bess2_g; x_bess3_g; x_pv4_g; x_pv5_g; x_bess6_g; w_g] ;
    ...
    results(k,1) = tin;
    results(k,2) = tfi;
    results(k,3:8) = [PV1.cost, BESS2.cost, BESS3.cost, PV4.cost, PV5.cost, BESS6.cost]/scale_factor;
end
